...
from src.schemas.contacts import ContactSchema, ContactUpdateSchema, ContactResponse, ContactStatusUpdate
...
@router.patch("/{contact_id}", response_model=ContactResponse, status_code=status.HTTP_200_OK, description='No more than 10 requests per minute',
            dependencies=[Depends(RateLimiter(times=3, seconds=60))])
